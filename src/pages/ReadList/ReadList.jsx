                            ...
                            <div className="ms-0 md:ms-5 mt-3 md:mt-0 flex-1 not-first card-bodies">
                                ...
                                <div className="flex gap-3 mt-3 flex-wrap">
                                    <div className="flex items-center align-baseline">
                                        ...
                                        <p className="text-[0.8rem]">Publisher: {item.publisher}</p>
                                    </div>
                            ...
                            return(
                                <div className="card bg-base-100 w-96 shadow-sm border border-gray-400 p-3 max-w-[250px] md:max-w-[300px]">
                                    ...
                                    <div className="card-bodies mt-3">
                                        <h2 className="card-title pb-3 text-[0.9rem]">{item.bookName}</h2>
                                        <p>
                                            <span className="font-bold">Total Pages:</span> {item.totalPages}
                                        </p>
                                        ...
                                        <p>
                                            <span className="font-bold">Year of Publishing:</span> {item.yearOfPublishing}
                                        </p>
                                    </div>
                                </div>
                            )
